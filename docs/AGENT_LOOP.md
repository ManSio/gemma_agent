...
## Positioning vs coding / multi-agent frameworks

| | Gemma (default) | Gemma (power) | MetaGPT / OpenHands / SWE-agent |
|--|-----------------|---------------|----------------------------------|
| Primary UI | Telegram | Telegram | IDE / terminal / API |
| Core loop | route → LLM → reply | goal runner + verify | long multi-step autonomous tasks |
| Model | OpenRouter (your choice) | same | hosted frontier |
| Target users | 3–8 trusted people | same | dev teams / research |
| Agent score (honest) | **6/10** | **7.5/10** | **8+/10** for their niche |

**Not claimed:** fundamental AI algorithm innovation (5/10). **Claimed:** orchestration + ops for a personal circle.

Full reviewer Q&A: [HONEST_POSITIONING.md](HONEST_POSITIONING.md)
