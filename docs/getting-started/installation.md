...
| RAM | **1 GB + swap** (tight; VPN optional on same host), **4 GB recommended** |
...
**Proven on real hardware:** 1 GB VPS (legacy, optional VPN stack), 4 GB VPS (prod), 3.5 GB LAN lab — see [System requirements](../SYSTEM_REQUIREMENTS.md).
