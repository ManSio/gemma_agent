...
How we verify quality before calling a release “green”. External reviewers: **run these commands** — do not assume absence of tests.
...
| Test cases | **2573+** (`pytest tests/ --collect-only`) |
