...
| [CACHE_LATENCY_METRICS_RU.md](CACHE_LATENCY_METRICS_RU.md) | Кэш OpenRouter/KV, задержки ответа, snapshot script |
| [CACHE_LATENCY_METRICS.md](CACHE_LATENCY_METRICS.md) | Cache & latency metrics (EN) |
