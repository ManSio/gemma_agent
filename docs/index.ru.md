...
| Тесты | **430** файлов · **2718+** кейсов — [CI.md](CI.md) |
| Честное позиционирование | [HONEST_POSITIONING.md](HONEST_POSITIONING.md) |
...
| [Честное позиционирование](HONEST_POSITIONING.md) | Ассистент vs агент, оценки, retrieval |
| [Метрики продакшена](PRODUCTION_EVIDENCE_REPORT.ru.md) | Май–июнь: токены −70%, расходы, latency, тесты |
| [Кэш и задержки](CACHE_LATENCY_METRICS_RU.md) | KV, p95 ответа, snapshot script |
